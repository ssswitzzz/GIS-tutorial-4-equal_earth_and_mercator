...
export const MainScene: React.FC = () => {
  ...
  return <AbsoluteFill style={{backgroundColor: PAPER, color: INK, fontFamily: SERIF, overflow: "hidden"}}><Audio src={staticFile("audio/intro.wav")} volume={0.9}/><div style={{width: 1920, height: 1080, transform: `scale(${scale})`, transformOrigin: "top left", position: "absolute", overflow: "hidden"}}>
    ...
    <div style={{position: "absolute", inset: 0, background: PAPER, opacity: ending, zIndex: 10}}/><div style={{position: "absolute", inset: 0, zIndex: 11, display: "flex", alignItems: "center", justifyContent: "center", flexDirection: "column", opacity: ending, transform: `translateY(${interpolate(ending, [0, 1], [34, 0], clamp)}px)`}}><div style={{fontSize: 37, color: CLAY, fontWeight: 700}}>一个问题，留到下一幕</div><div style={{fontSize: 92, fontWeight: 700, marginTop: 22}}>墨卡托，真的在“骗”我们吗？</div><div style={{marginTop: 34, fontSize: 34, color: "#557067"}}>还是说，这口锅不该由它来背？</div></div>
